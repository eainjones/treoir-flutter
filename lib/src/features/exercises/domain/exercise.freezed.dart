...
mixin _$Exercise {
 ...
 String get id; String get name; String get category; String get primaryMuscle; List<String> get secondaryMuscles; String get equipment; bool get isCustom;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,category,primaryMuscle,const DeepCollectionEquality().hash(secondaryMuscles),equipment,isCustom);

@override
String toString() {
  return 'Exercise(id: $id, name: $name, category: $category, primaryMuscle: $primaryMuscle, secondaryMuscles: $secondaryMuscles, equipment: $equipment, isCustom: $isCustom)';
}
...
@useResult
$Res call({
 String id, String name, String category, String primaryMuscle, List<String> secondaryMuscles, String equipment, bool isCustom
});
...
/// Create a copy of Exercise
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? category = null,Object? primaryMuscle = null,Object? secondaryMuscles = null,Object? equipment = null,Object? isCustom = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String category,  String primaryMuscle,  List<String> secondaryMuscles,  String equipment,  bool isCustom)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Exercise() when $default != null:
return $default(_that.id,_that.name,_that.category,_that.primaryMuscle,_that.secondaryMuscles,_that.equipment,_that.isCustom);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String category,  String primaryMuscle,  List<String> secondaryMuscles,  String equipment,  bool isCustom)  $default,) {final _that = this;
switch (_that) {
case _Exercise():
return $default(_that.id,_that.name,_that.category,_that.primaryMuscle,_that.secondaryMuscles,_that.equipment,_that.isCustom);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String category,  String primaryMuscle,  List<String> secondaryMuscles,  String equipment,  bool isCustom)?  $default,) {final _that = this;
switch (_that) {
case _Exercise() when $default != null:
return $default(_that.id,_that.name,_that.category,_that.primaryMuscle,_that.secondaryMuscles,_that.equipment,_that.isCustom);case _:
  return null;
...
class _Exercise implements Exercise {
  const _Exercise({required this.id, required this.name, required this.category, required this.primaryMuscle, final  List<String> secondaryMuscles = const [], required this.equipment, this.isCustom = false}): _secondaryMuscles = secondaryMuscles;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,category,primaryMuscle,const DeepCollectionEquality().hash(_secondaryMuscles),equipment,isCustom);
...
/// Create a copy of Exercise
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? category = null,Object? primaryMuscle = null,Object? secondaryMuscles = null,Object? equipment = null,Object? isCustom = null,}) {
